/*
  ...
  - Added the required column `load` to the `Workout` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "load" INTEGER NOT NULL,
